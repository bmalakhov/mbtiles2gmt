...
6) Если каталог C:\SasPlanet\maps\<имя карты>.zmp существует, скрип предложит его удалить. И далее создаст автоматически файл params.txt и пропишет туда нужные данные.
